...
const calIds = [require('./login.json').ab, require('./login.json').am, require('./login.json').w, require('./login.json').PriveCalendar];
const calId = require('./login.json').PriveCalendar;
const calColors = [[3, 0, 0], [0, 3, 0], [0, 0, 3], [0, 3, 3]] //[[0, 0, 0], [0, 0, 0], [0, 0, 0]]
